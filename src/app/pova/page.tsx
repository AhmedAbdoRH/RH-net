...
import { ChevronDown, ShieldAlert, Code2, User, Receipt, NotebookPen, Globe, Building2, LayoutGrid, CreditCard, Droplets, Wind, Rss, Trophy } from 'lucide-react';
...
export default function PovaPage() {
  ...
  const filteredDomainsForStatusPanel = React.useMemo(() => {
    return allDomains.filter(d => d.projects?.includes('pova'));
  }, [allDomains]);
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-foreground">لوحة مشاريع Pova</h1>
              </div>
            </div>
